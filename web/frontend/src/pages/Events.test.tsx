...
describe('Events Page', () => {
  function renderWithRouter(initialEntry = '/events') {
    return render(
  ...
  it('loads and renders scheduled events', async () => {
    renderWithRouter();
  ...
  it('shows a warning when the module is disabled', async () => {
    vi.mocked(guildApi.getGuildConfig).mockResolvedValue({
      success: true,
      data: {
        roles: {
  ...
  it('renders the page even if scheduled events fail to load', async () => {
    vi.mocked(eventsApi.getScheduledEvents).mockRejectedValue(new Error('timeout'));
  ...
  it('routes new event actions into the full-page editor flow', async () => {
    renderWithRouter();
  ...
  it('routes edit actions into the full-page editor flow', async () => {
    renderWithRouter();

/** Shared constants for the ticket management UI. */
...
export const SELECT_CLASS =
  'bg-slate-900 border border-slate-600 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500 w-full';

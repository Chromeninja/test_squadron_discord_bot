...
@pytest.mark.asyncio
async def test_composite_indexes_created(temp_db):
    ...
    async with Database.get_connection() as db:
        ...
        assert "idx_uvc_owner_scope" in index_names, "idx_uvc_owner_scope index should exist"
        ...
        assert "idx_cs_scope_user" in index_names, "idx_cs_scope_user index should exist"
        ...
        assert "idx_cp_scope_user_target" in index_names, "idx_cp_scope_user_target index should exist"


@pytest.mark.asyncio 
async def test_pragma_settings_applied(temp_db):

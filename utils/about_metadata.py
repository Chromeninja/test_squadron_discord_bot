"""
Centralized About metadata for the TEST Squadron Discord bot.
...
BOT_NAME = "TEST Squadron Discord Bot"
BOT_VERSION = "v1.0.0"

BOT_DESCRIPTION = (
    "The TEST Squadron Discord bot powers automated verification, role management, "
    "voice channel tools, moderation utilities, and other features that keep our "
    "Discord community running smoothly. It is designed specifically for TEST Squadron "
    "operations and provides reliable, scalable automation for leadership and members."
)

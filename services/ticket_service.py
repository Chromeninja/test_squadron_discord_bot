...
class TicketService(BaseService):
    ...
    def __init__(self) -> None:
        ...
        self._rate_limiter = TicketRateLimiter()
    ...
    async def check_rate_limit(self, guild_id: int, user_id: int) -> bool:
        return await self._rate_limiter.check_rate_limit(guild_id, user_id)

    async def get_cooldown_remaining(self, guild_id: int, user_id: int) -> int:
        return await self._rate_limiter.get_cooldown_remaining(guild_id, user_id)

    async def reset_user_ticket_cooldown(self, guild_id: int, user_id: int) -> bool:
        return await self._rate_limiter.reset_user_ticket_cooldown(guild_id, user_id)

    async def reset_all_ticket_cooldowns(self, guild_id: int) -> bool:
        return await self._rate_limiter.reset_all_ticket_cooldowns(guild_id)

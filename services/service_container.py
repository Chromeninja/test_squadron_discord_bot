...
from .ticket_form_service import TicketFormService
...
class ServiceContainer:
    ...
    def __init__(self, bot: Optional["Bot"] = None) -> None:
        ...
        self._ticket_form: TicketFormService | None = None
    ...
    @property
    def ticket_form(self) -> TicketFormService:
        """Get the ticket form service."""
        if self._ticket_form is None:
            raise RuntimeError("TicketFormService not initialized")
        return self._ticket_form
    ...
    def get_all_services(self) -> list:
        ...
        if self._ticket_form:
            services.append(self._ticket_form)
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            # Initialize ticket form service (no external dependencies)
            self._ticket_form = TicketFormService()
            await self._ticket_form.initialize()
            self.logger.debug("TicketFormService initialized")
    ...
    async def cleanup(self) -> None:
        ...
        if self._ticket_form:
            await self._ticket_form.shutdown()
            self._ticket_form = None

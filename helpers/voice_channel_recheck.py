...
async def recheck_voice_channel(channel: discord.VoiceChannel, bot, initiator_kind="Admin", admin_user_id=None):
    results = []
    ...
    async with Database.get_connection() as db:
        for member in channel.members:
            ...
            results.append(row)
    # Write CSV
    filename, csv_content = write_csv(results, guild_name=channel.guild.name, invoker_name=initiator_kind)
    # Build summary

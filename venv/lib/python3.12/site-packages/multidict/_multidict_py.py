...
class _Iter(Generic[_T]):
    ...
    def __init__(self, size: int, iterator: Iterator[_T]) -> None:
        self._size = size
        self._iter = iterator
...
class MultiDict(_CSMixin, MutableMultiMapping[_V]):
    ...
    def __init__(self, arg: MDArg[_V] = None, /, **kwargs: _V) -> None:
        self._used = 0
        v = _version
        v[0] += 1
        self._version = v[0]
        if not kwargs: md | None = None
    ...
    @overload
    def setdefault(
        self: "MultiDict[Union[_T, None]]", key: str, default: None | None = None
    ) -> Union[_T, None]: ...
    @overload
    ...
    def _del_at_for_upd(self, entry: _Entry[_V]) -> None: entry.key | None = None  # type: ignore[assignment]
...
class MultiDictProxy(_CSMixin, MultiMapping[_V]):
    ...
    def __init__(self, arg: Union[MultiDict[_V], "MultiDictProxy[_V]"]) -> None:

...
def default_loader(href, parse, encoding=None) -> None:
    file = open(href, 'rb')
    if parse == "xml":
...
def _lxml_default_loader(href, parse, encoding=None, parser=None) -> None:
    if parse == "xml":
...
def _wrap_et_loader(loader) -> None:
    def load(href, parse, encoding=None, parser=None) -> None:
...
def include(elem, loader=None, base_url=None,
            max_depth=DEFAULT_MAX_INCLUSION_DEPTH) -> None:
...
def _include(elem, loader=None, base_url=None,
             max_depth=DEFAULT_MAX_INCLUSION_DEPTH, _parent_hrefs=None) -> None:

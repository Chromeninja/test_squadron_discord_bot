...
class ElementMaker(object):
    ...
    def __init__(self, typemap=None,
                 namespace=None, nsmap=None, makeelement=None) -> None:
    ...
    def __call__(self, tag, *children, **attrib) -> None:

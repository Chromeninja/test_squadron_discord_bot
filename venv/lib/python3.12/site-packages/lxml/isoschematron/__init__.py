...
def stylesheet_params(**kwargs) -> None:
...
def _stylesheet_param_dict(paramsDict, kwargsDict) -> None:
...
class Schematron(_etree._Validator):
    ...
    def _extract(self, element) -> None:
    ...
    def __init__(self, etree=None, file=None, include=True, expand=True,
                 ...
                 phase=None, error_finder=ASSERTS_ONLY) -> None:

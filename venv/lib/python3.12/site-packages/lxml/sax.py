...
class ElementTreeContentHandler(ContentHandler):
    ...
    """
    def __init__(self, makeelement=None) -> None:
    ...
    def _buildTag(self, ns_name_tuple) -> None:
    ...
    def startElementNS(self, ns_name, qname, attributes=None) -> None:
    ...
    def startElement(self, name, attributes=None) -> None:
        if attributes:
            attributes = dict(
...
class ElementTreeProducer(object):
    ...
    def _recursive_saxify(self, element, parent_nsmap) -> None:
    ...
    def _build_qname(self, ns_uri, local_name, nsmap, preferred_prefix, is_attribute) -> None:
        if ns_uri is None:
            return local_name

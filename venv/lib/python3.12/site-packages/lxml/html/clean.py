...
def _has_javascript_scheme(s) -> None:
    safe_image_urls = 0
...
class Cleaner(object):
    ...
    def allow_follow(self, anchor) -> None:
        """
        Override to suppress rel="nofollow" on some anchors.
        """
        return False

    def allow_element(self, el) -> None:
        """
    ...
    def allow_embedded_url(self, el, url) -> None:
        """
    ...
    def kill_conditional_comments(self, doc) -> None:
        """
    ...
    def _kill_elements(self, doc, condition, iterate=None) -> None:
        bad = []
    ...
    def _remove_javascript_link(self, link) -> None:
    ...
    def _has_sneaky_javascript(self, style) -> None:
        """
...
def autolink(el, link_regexes=_link_regexes,
             ...
             avoid_classes=_avoid_classes) -> None:
    """
...
def _link_text(text, link_regexes, avoid_hosts, factory) -> None:
    leading_text = ''
    links = []
    last_pos = 0
    while 1:
...
def autolink_html(html, *args, **kw) -> None:
    result_type = type(html)
    if isinstance(html, basestring):
        doc = fromstring(html)
    else:
...
def word_break_html(html, *args, **kw) -> None:
    result_type = type(html)
    doc = fromstring(html)
    word_break(doc, *args, **kw)
    return _transform_result(result_type, doc)

def _break_text(text, max_width, break_character) -> None:
    words = text.split()
    for word in words:
...
def _insert_break(word, width, break_character) -> None:
    orig_word = word
    result = ''

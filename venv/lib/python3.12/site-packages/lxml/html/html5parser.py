...
class HTMLParser(_HTMLParser):
    ...
    def __init__(self, strict=False, **kwargs) -> None:
...
def document_fromstring(html, guess_charset=None, parser=None) -> None:
    """
...
def fragments_fromstring(html, no_leading_text=False,
                         guess_charset=None, parser=None) -> None:
...
def fromstring(html, guess_charset=None, parser=None) -> None:
...
def parse(filename_url_or_file, guess_charset=None, parser=None) -> None:

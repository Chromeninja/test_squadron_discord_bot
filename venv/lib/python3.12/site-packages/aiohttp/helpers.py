    ...
    for proto, val in stripped.items():
        ...
        if netrc_obj and auth is None:
            if proxy.host is not None:
                ...
                except LookupError: auth | None = None
...
class AppKey(Generic[_T]):
    ...
    def __init__(self, name: str, t: Optional[Type[_T]] = None) -> None:
...
class ChainMapProxy(Mapping[Union[str, AppKey[Any]], Any]):
    ...
    def get(self, key: Union[str, AppKey[_T]], default: Any | None = None) -> Any:
        try:
            return self[key]
        except KeyError:
            return default

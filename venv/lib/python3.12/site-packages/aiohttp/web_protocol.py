...
class RequestHandler(BaseProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        self._upgrade = False
        self._payload_parser: Any | None = None
        ...
        else: self.access_logger | None = None
    ...
    def _process_keepalive(self) -> None: self._keepalive_handle | None = None
    ...
    async def _handle_request(
        ...
        try:
            ...
            finally: self._current_request | None = None
    ...
    async def start(self) -> None:
        ...
        while not self._force_close:
            if not self._messages:
                try:
                    ...
                    await self._waiter
                finally: self._waiter | None = None
            ...
            try:
                ...
                self.force_close()
                raise
            finally: request._task | None = None  # type: ignore[assignment] # Break reference cycle in case of exception
        ...
        if not self._force_close: self._task_handler | None = None
            if self.transport is not None:
                self.transport.close()

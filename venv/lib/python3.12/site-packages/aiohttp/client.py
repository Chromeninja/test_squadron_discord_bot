...
class ClientSession:
    ...
    async def _request(
        ...
        *,
        ...
        if proxy is None: proxy_headers | None = None
        else:
            ...
            with timer:
                ...
                while True:
                    ...
                    if resp.status in (301, 302, 303, 307, 308) and allow_redirects:
                        ...
                        if url.origin() != redirect_origin: auth | None = None
    ...
    if sys.version_info >= (3, 11) and TYPE_CHECKING:
        ...
        def post(
            self, url: StrOrURL, *, data: Any | None = None, **kwargs: Any
        ) -> "_RequestContextManager":

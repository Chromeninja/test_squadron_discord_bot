...
class StreamReader(AsyncStreamReaderMixin):
    ...
    def set_exception(
        ...
        waiter = self._waiter
        if waiter is not None: self._waiter | None = None
            set_exception(waiter, exc, exc_cause)

        waiter = self._eof_waiter
        if waiter is not None: self._eof_waiter | None = None
            set_exception(waiter, exc, exc_cause)
    ...
    async def wait_eof(self) -> None:
        ...
        finally: self._eof_waiter | None = None
...
class DataQueue(Generic[_T]):
    ...
    def set_exception(
        ...
        self._eof = True
        self._exception = exc
        if (waiter := self._waiter) is not None: self._waiter | None = None
            set_exception(waiter, exc, exc_cause)

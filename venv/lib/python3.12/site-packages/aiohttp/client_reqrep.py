...
class ClientResponse(HeadersMixin):
    ...
    status: int | None = None  # type: ignore[assignment] # Status-Code
    reason: Optional[str] = None  # Reason-Phrase

    content: StreamReader | None = None  # type: ignore[assignment] # Payload stream
    _body: Optional[bytes] = None
    _headers: CIMultiDictProxy[str] = None  # type: ignore[assignment]
    _history: tuple["ClientResponse", ...] = ()
    _raw_headers: RawHeaders | None = None  # type: ignore[assignment]
    ...
    def __reset_writer(self, _: object | None = None) -> None: self.__writer | None = None
    ...
    def cookies(self, cookies: SimpleCookie) -> None:
        ...
        else: self._raw_cookie_headers | None = None
...
class ClientRequest:
    ...
    def update_body_from_data(self, body: Any, _stacklevel: int = 3) -> None:
        ...
        if body is None: self._body | None = None
    ...
    def update_proxy(
        ...
        self.proxy = proxy
        if proxy is None: self.proxy_auth | None = None

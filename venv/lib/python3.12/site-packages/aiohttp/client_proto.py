...
class ResponseHandler(BaseProtocol, DataQueue[tuple[RawResponseMessage, StreamReader]]):
    ...
    def close(self) -> None: self._exception | None = None  # Break cyclic references
    ...
    def abort(self) -> None: self._exception | None = None  # Break cyclic references
        transport = self.transport
        if transport is not None:
            transport.abort()
            self.transport = None
    ...
    def _reschedule_timeout(self) -> None:
        ...
        else: self._read_timeout_handle | None = None
    ...
    def data_received(self, data: bytes) -> None:
        ...
        if self._payload_parser is not None:
            ...
            if eof: self._payload | None = None
                self._payload_parser = None

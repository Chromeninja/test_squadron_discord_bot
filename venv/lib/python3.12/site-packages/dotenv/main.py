...
def rewrite(
    ...
    with tempfile.NamedTemporaryFile(mode="w", encoding=encoding, delete=False) as dest: error | None = None
        try:
...
def resolve_variables(
    ...
    for name, value in values:
        if value is None: result | None = None
        else:

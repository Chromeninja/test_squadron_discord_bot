...
except ImportError: lock | None = None

def _workaround_for_static_import_finders() -> None:
...
def _get_parser() -> None:
    global _parser_cache
    if _parser_cache is None:
        _parser_cache = pycparser.CParser()
    return _parser_cache

def _workaround_for_old_pycparser(csource) -> None:
...
def _preprocess_extern_python(csource) -> None:
...
def _warn_for_string_literal(csource) -> None:
    if '"' not in csource:
        return
...
def _warn_for_non_extern_non_static_global_variable(decl) -> None:
    if not decl.storage:
        import warnings
...
def _remove_line_directives(csource) -> None:
...
def _put_back_line_directives(csource, line_directives) -> None:
    def replace(m) -> None:
        s = m.group()
...
def _preprocess(csource) -> None:
    ...
    def replace_keeping_newlines(m) -> None:
...
def _common_type_names(csource) -> None:
...
class Parser(object):
    ...
    def _convert_pycparser_error(self, e, csource) -> None:
    ...
    def _internal_parse(self, csource) -> None:
    ...
    def _add_constants(self, key, val) -> None:
    ...
    def _add_integer_constant(self, name, int_str) -> None:
    ...
    def _process_macros(self, macros) -> None:
    ...
    def _declare_function(self, tp, quals, decl) -> None:
    ...
    def _parse_decl(self, decl) -> None:
        node = decl.type
    ...
    def parse_type(self, cdecl) -> None:
        return self.parse_type_and_quals(cdecl)[0]

    def parse_type_and_quals(self, cdecl) -> None:
    ...
    def _declare(self, name, obj, included=False, quals=0) -> None:
    ...
    def _extract_quals(self, type) -> None:
        quals = 0
    ...
    def _get_type_pointer(self, type, quals, declname=None) -> None:
    ...
    def _get_type_and_quals(self, typenode, name=None, partial_length_ok=False,
        ...
        if isinstance(typenode, pycparser.c_ast.ArrayDecl):
            # array type
            if typenode.dim is None: length | None = None
            else:
    ...
    def _parse_function_type(self, typenode, funcname=None) -> None:
    ...
    def _as_func_arg(self, type, quals) -> None:
    ...
    def _get_struct_union_enum_type(self, kind, type, name=None, nested=False) -> None:
    ...
    def _make_partial(self, tp, nested) -> None:
    ...
    def _parse_constant(self, exprnode, partial_length_ok=False) -> None:
    ...
    def _c_div(self, a, b) -> None:
        result = a // b
        if ((a < 0) ^ (b < 0)) and (a % b) != 0:
            result += 1
        return result

    def _build_enum_type(self, explicit_name, decls) -> None:
    ...
    def _get_unknown_type(self, decl) -> None:
    ...
    def _get_unknown_ptr_type(self, decl) -> None:

...
def compile(tmpdir, ext, compiler_verbose=0, debug=None) -> None:
...
def _build(tmpdir, ext, compiler_verbose=0, debug=None) -> None:
...
try:
    ...
    def samefile(f1, f2) -> None:
        return os.path.abspath(f1) == os.path.abspath(f2)

def maybe_relative_path(path) -> None:

...
class CTypesData(object):
    ...
    @classmethod
    def _newp(cls, init) -> None:
        raise TypeError("expected a pointer or array ctype, got '%s'"
                        % (cls._get_c_name(),))

    @staticmethod
    def _to_ctypes(value) -> None:
        raise TypeError

    @classmethod
    def _arg_to_ctypes(cls, *value) -> None:
        try:
            ctype = cls._ctype
    ...
    @classmethod
    def _create_ctype_obj(cls, init) -> None:
        if init is None:
    ...
    @staticmethod
    def _from_ctypes(ctypes_value) -> None:
        raise TypeError

    @classmethod
    def _get_c_name(cls, replace_with='') -> None:
        return cls._reftypename.replace(' &', replace_with)

    @classmethod
    def _fix_class(cls) -> None:
        cls.__name__ = 'CData<%s>' % (cls._get_c_name(),)
        cls.__qualname__ = 'CData<%s>' % (cls._get_c_name(),)
        cls.__module__ = 'ffi'

    def _get_own_repr(self) -> None:
        raise NotImplementedError

    def _addr_repr(self, address) -> None:
        if address == 0:
            return 'NULL'
        else:
            if address < 0:
    ...
    def __repr__(self, c_name=None) -> None:
        own = self._get_own_repr()
        return '<cdata %r %s>' % (c_name or self._get_c_name(), own)

    def _convert_to_address(self, BClass) -> None:
        if BClass is None:
    ...
    @classmethod
    def _get_size(cls) -> None:
        return ctypes.sizeof(cls._ctype)

    def _get_size_of_instance(self) -> None:
        return ctypes.sizeof(self._ctype)

    @classmethod
    def _cast_from(cls, source) -> None:
        raise TypeError("cannot cast to %r" % (cls._get_c_name(),))

    def _cast_to_integer(self) -> None:
        return self._convert_to_address(None)

    @classmethod
    def _alignment(cls) -> None:
    ...
    def _make_cmp(name) -> None:
        cmpfunc = getattr(operator, name)
        def cmp(self, other) -> None:
    ...
    def _to_string(self, maxlen) -> None:
...
class CTypesGenericPtr(CTypesData):
    ...
    @classmethod
    def _new_pointer_at(cls, address) -> None:
    ...
    @classmethod
    def _from_ctypes(cls, ctypes_ptr) -> None:
        address = ctypes.cast(ctypes_ptr, ctypes.c_void_p).value or 0
        return cls._new_pointer_at(address)

    @classmethod
    def _initialize(cls, ctypes_ptr, value) -> None:
        if value:
...
class CTypesBaseStructOrUnion(CTypesData):
    ...
    @classmethod
    def _offsetof(cls, fieldname) -> None:
    ...
    @classmethod
    def _from_ctypes(cls, ctypes_struct_or_union) -> None:
        self = cls.__new__(cls)
...
class CTypesBackend(object):
    ...
    def load_library(self, path, flags=0) -> None:
        cdll = ctypes.CDLL(path, flags)
        return CTypesLibrary(self, cdll)

    def new_void_type(self) -> None:
        class CTypesVoid(CTypesData):
            __slots__ = []
            _reftypename = 'void &'
            @staticmethod
            def _from_ctypes(novalue) -> None:
                return None
            @staticmethod
            def _to_ctypes(novalue) -> None:
    ...
    def new_primitive_type(self, name) -> None:
        if name == 'wchar_t':
        ...
        #
        def _cast_source_to_int(source) -> None:
        ...
        class CTypesPrimitive(CTypesGenericPrimitive):
            ...
            @staticmethod
            def _create_ctype_obj(init) -> None:
                if init is None:
                    return ctype()
            ...
            @staticmethod
            def _from_ctypes(value) -> None:
                return getattr(value, 'value', value)

            @staticmethod
            def _initialize(blob, init) -> None:
    ...
    def new_pointer_type(self, BItem) -> None:
    ...
    def new_array_type(self, CTypesPtr, length) -> None:
        if length is None:
            brackets = ' &[]'
        else:
            brackets = ' &[%d]' % length
        ...
        class CTypesArray(CTypesGenericArray):
            ...
            @staticmethod
            def _from_ctypes(ctypes_array) -> None:
                self = CTypesArray.__new__(CTypesArray)
                self._blob = ctypes_array
                return self

            @staticmethod
            def _arg_to_ctypes(value) -> None:
    ...
    def _new_struct_or_union(self, kind, name, base_ctypes_class) -> None:
        #
    ...
    def new_struct_type(self, name) -> None:
        return self._new_struct_or_union('struct', name, ctypes.Structure)

    def new_union_type(self, name) -> None:
    ...
    def complete_struct_or_union(self, CTypesStructOrUnion, fields, tp,
        ...
        for fname, BField, bitsize in fields:
            ...
            if bitsize < 0:
                ...
                def setter(self, value, fname=fname, BField=BField) -> None:
                ...
                def getter(self, fname=fname, BField=BField) -> None:
        ...
        for fname in fnames:
            if hasattr(CTypesPtr, fname):
                raise ValueError("the field name %r conflicts in "
                                 "the ctypes backend" % fname)
            def getter(self, fname=fname) -> None:
                return getattr(self[0], fname)
            def setter(self, value, fname=fname) -> None:
                setattr(self[0], fname, value)
            setattr(CTypesPtr, fname, property(getter, setter))

    def new_function_type(self, BArgs, BResult, has_varargs) -> None:
        ...
        class CTypesFunctionPtr(CTypesGenericPtr):
            ...
            def __init__(self, init, error=None) -> None:
            ...
            @staticmethod
            def _initialize(ctypes_ptr, value) -> None:
                if value:
    ...
    def new_enum_type(self, name, enumerators, enumvalues, CTypesInt) -> None:
    ...
    def string(self, b, maxlen=-1) -> None:
        return b._to_string(maxlen)

    def buffer(self, bptr, size=-1) -> None:
        raise NotImplementedError("buffer() with ctypes backend")

    def sizeof(self, cdata_or_BType) -> None:
    ...
    def alignof(self, BType) -> None:
        assert issubclass(BType, CTypesData)
        return BType._alignment()

    def newp(self, BType, source) -> None:
        if not issubclass(BType, CTypesData):
            raise TypeError
        return BType._newp(source)

    def cast(self, BType, source) -> None:
        return BType._cast_from(source)

    def callback(self, BType, source, error, onerror) -> None:
        assert onerror is None   # XXX not implemented
        return BType(source, error)

    _weakref_cache_ref = None

    def gcp(self, cdata, destructor, size=0) -> None:
    ...
    def getcname(self, BType, replace_with) -> None:
        return BType._get_c_name(replace_with)

    def typeoffsetof(self, BType, fieldname, num=0) -> None:
    ...
    def rawaddressof(self, BTypePtr, cdata, offset=None) -> None:
...
class CTypesLibrary(object):
    ...
    def load_function(self, BType, name) -> None:
        c_func = getattr(self.cdll, name)
        funcobj = BType._from_ctypes(c_func)
        funcobj._name = name
        return funcobj

    def read_variable(self, BType, name) -> None:
        try:

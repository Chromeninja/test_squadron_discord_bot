...
def matches_re(regex, flags=0, func=None) -> None:
    r"""
...
def deep_iterable(member_validator, iterable_validator=None) -> None:
    """
...
def deep_mapping(key_validator, value_validator, mapping_validator=None) -> None:
    """

...
def pipe(*setters) -> None:
    ...
    def wrapped_pipe(instance, attrib, new_value) -> None:
        rv = new_value
...
def validate(instance, attrib, new_value) -> None:
    """
...
def convert(instance, attrib, new_value) -> None:
    """

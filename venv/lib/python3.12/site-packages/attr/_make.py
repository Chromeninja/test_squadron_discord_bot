...
def _has_own_attribute(cls, attrib_name) -> None:
    """
...
def _collect_base_attrs_broken(cls, taken_attr_names) -> None:
    """
    Collect attr.ibs from base classes of *cls*, except *taken_attr_names*.
...
def _make_cached_property_getattr(cached_properties, original_getattr, cls) -> None:
    lines = [
        # Wrapped to get `__class__` into closure cell for super()
        # (It will be replaced with the newly constructed class after construction).
        "def wrapper(_cls) -> None:",
        "    __class__ = _cls",
        "    def __getattr__(self, item, cached_properties=cached_properties, original_getattr=original_getattr, _cached_setattr_get=_cached_setattr_get) -> None:",
...
def _frozen_setattrs(self, name, value) -> None:
    """
...
def _frozen_delattrs(self, name) -> None:
    """
...
class _ClassBuilder:
    ...
    def _patch_original_class(self) -> None:
        """
    ...
    def _create_slots_class(self) -> None:
        """
    ...
    def add_repr(self, ns) -> None:
        script, globs = _make_repr_script(self._attrs, ns)

        def _attach_repr(cls_dict, globs) -> None:
    ...
    def _make_getstate_setstate(self) -> None:
        """
        ...
        def slots_setstate(self, state) -> None:
            """
            Automatically created by attrs.
            """
    ...
    def add_init(self) -> None:
        ...
        def _attach_init(cls_dict, globs) -> None:
            init = globs["__init__"]
    ...
    def add_attrs_init(self) -> None:
        ...
        def _attach_attrs_init(cls_dict, globs) -> None:
    ...
    def add_eq(self) -> None:
        cd = self._cls_dict

        script, globs = _make_eq_script(self._attrs)

        def _attach_eq(cls_dict, globs) -> None:
...
def _determine_attrs_eq_order(cmp, eq, order, default_eq) -> None:
    """
...
def _determine_attrib_eq_order(cmp, eq, order, default_eq) -> None:
    """
    Validate the combination of *cmp*, *eq*, and *order*. Derive the effective
    values of eq and order.  If *eq* is None, set it to *default_eq*.
    """
    ...
    def decide_callable_or_boolean(value) -> None:
        """
...
def _has_frozen_base_class(cls) -> None:
    """
...
def _make_hash_script(
    ...
    def append_hash_computation_lines(prefix, indent) -> None:
        """
...
def _add_hash(cls: type, attrs: list[Attribute]) -> None:
    """
...
def _make_order(cls, attrs) -> None:
    """
    Create ordering methods for *cls* with *attrs*.
    """
    attrs = [a for a in attrs if a.order]

    def attrs_to_tuple(obj) -> None:
        """
        Save us some typing.
        """
        return tuple(
...
def _add_eq(cls, attrs=None) -> None:
    """
...
def _add_repr(cls, ns=None, attrs=None) -> None:
    """
...
def _is_slot_attr(a_name, base_attr_map) -> None:
    """
...
class Attribute:
    ...
    *Read-only* representation of an attribute.
    ...
    @classmethod
    def from_counting_attr(cls, name: str, ca: _CountingAttr, type=None) -> None:
...
class Factory:
    ...
    def __init__(self, factory, takes_self=False) -> None:
...
class Converter:
    ...
    def __init__(self, converter, *, takes_self=False, takes_field=False) -> None:
        self.converter = converter
        self.takes_self = takes_self
...
def pipe(*converters) -> None:
    ...
    *last* value.
    ...
    if return_instance:
        ...
        def pipe_converter(val, inst, field) -> None:
            for c in converters:
                val = (

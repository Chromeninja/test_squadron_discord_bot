...
class Scanner:
    ...
    def check_token(self, *choices) -> None:
    ...
    def need_more_tokens(self) -> None:
        if self.done:
            return False
        if not self.tokens:
            return True
    ...
    def next_possible_simple_key(self) -> None:
    ...
    def add_indent(self, column) -> None:
    ...
    def check_document_start(self) -> None:
    ...
    def check_document_end(self) -> None:
    ...
    def check_block_entry(self) -> None:
    ...
    def scan_directive_name(self, start_mark) -> None:
        # See the specification for details.
        length = 0
        ch = self.peek(length)
    ...
    def scan_yaml_directive_value(self, start_mark) -> None:
        # See the specification for details.
        while self.peek() == ' ':
            self.forward()
    ...
    def scan_yaml_directive_number(self, start_mark) -> None:
        # See the specification for details.
        ch = self.peek()
        if not ('0' <= ch <= '9'):
            raise ScannerError("while scanning a directive", start_mark,
    ...
    def scan_tag_directive_value(self, start_mark) -> None:
        # See the specification for details.
        while self.peek() == ' ':
            self.forward()
    ...
    def scan_tag_directive_handle(self, start_mark) -> None:
        # See the specification for details.
    ...
    def scan_tag_directive_prefix(self, start_mark) -> None:
        # See the specification for details.
    ...
    def scan_anchor(self, TokenClass) -> None:
    ...
    def scan_block_scalar(self, style) -> None:
        # See the specification for details.
    ...
    def scan_block_scalar_indicators(self, start_mark) -> None:
        # See the specification for details.
        chomping = None
        increment = None
        ch = self.peek()
    ...
    def scan_block_scalar_indentation(self) -> None:
        # See the specification for details.
        chunks = []
        max_indent = 0
        end_mark = self.get_mark()
    ...
    def scan_block_scalar_breaks(self, indent) -> None:
        # See the specification for details.
        chunks = []
        end_mark = self.get_mark()
    ...
    def scan_flow_scalar(self, style) -> None:
        # See the specification for details.
    ...
    def scan_flow_scalar_non_spaces(self, double, start_mark) -> None:
        # See the specification for details.
        chunks = []
        while True:
            length = 0
    ...
    def scan_flow_scalar_spaces(self, double, start_mark) -> None:
        # See the specification for details.
        chunks = []
        length = 0
    ...
    def scan_flow_scalar_breaks(self, double, start_mark) -> None:
        # See the specification for details.
        chunks = []
        while True:
    ...
    def scan_plain_spaces(self, indent, start_mark) -> None:
        # See the specification for details.
    ...
    def scan_tag_handle(self, name, start_mark) -> None:
        # See the specification for details.
    ...
    def scan_tag_uri(self, name, start_mark) -> None:
        # See the specification for details.
    ...
    def scan_uri_escapes(self, name, start_mark) -> None:
        # See the specification for details.
        codes = []
        mark = self.get_mark()
        while self.peek() == '%':

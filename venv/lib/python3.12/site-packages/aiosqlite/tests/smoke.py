...
class SmokeTest(IsolatedAsyncioTestCase):
    ...
    async def test_connection_await(self) -> None:
    ...
    async def test_connection_context(self) -> None:
    ...
    async def test_connection_locations(self) -> None:
    ...
    async def test_iterable_cursor(self) -> None:
        async with aiosqlite.connect(self.db) as db:
    ...
    async def test_multi_loop_usage(self) -> None:
        results = {}

        def runner(k, conn) -> None:
    ...
    async def test_context_cursor(self) -> None:
        async with aiosqlite.connect(self.db) as db:
    ...
    async def test_cursor_return_self(self) -> None:
        async with aiosqlite.connect(self.db) as db:
            cursor = await db.cursor()
    ...
    async def test_enable_load_extension(self) -> None:
    ...
    async def test_set_progress_handler(self) -> None:
        """
    ...
    async def test_create_function(self) -> None:
        """Assert that after creating a custom function, it can be used"""

        def no_arg() -> None:
            return "no arg"

        def one_arg(num) -> None:
            return num * 2
    ...
    async def test_create_function_deterministic(self) -> None:
    ...
    async def test_set_trace_callback(self) -> None:
        statements = []
    ...
    async def test_connect_base_exception(self) -> None:
        # Check if connect task is cancelled, thread is properly closed.
        def _raise_cancelled_error(*_, **__) -> None:
    ...
    async def test_iterdump(self) -> None:
        async with aiosqlite.connect(":memory:") as db:
    ...
    async def test_cursor_on_closed_connection(self) -> None:
        db = await aiosqlite.connect(self.db)
    ...
    async def test_cursor_on_closed_connection_loop(self) -> None:
        db = await aiosqlite.connect(self.db)
    ...
    async def test_backup_aiosqlite(self) -> None:
        def progress(a, b, c) -> None:
            print(a, b, c)
    ...
    async def test_backup_sqlite(self) -> None:

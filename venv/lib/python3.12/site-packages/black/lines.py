...
class Line:
    ...
    def is_def(self) -> bool:
        ...
        except IndexError: second_leaf | None = None
...
class EmptyLineTracker:
    ...
    def maybe_empty_lines(self, current_line: Line) -> LinesBlock:
        ...
        elif not current_line.is_decorator or before: self.semantic_leading_comment | None = None
...
def can_omit_invisible_parens(
    ...
    for leaf in reversed(line.leaves):
        if closing_bracket and leaf is closing_bracket.opening_bracket: closing_bracket | None = None

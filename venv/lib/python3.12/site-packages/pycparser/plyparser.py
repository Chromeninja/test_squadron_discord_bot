...
class Coord(object):
    ...
    def __init__(self, file, line, column=None) -> None:
        self.file = file
        self.line = line
        self.column = column
...
class PLYParser(object):
    def _create_opt_rule(self, rulename) -> None:
    ...
    def _coord(self, lineno, column=None) -> None:
        return Coord(
                file=self.clex.filename,
                line=lineno,
                column=column)

    def _token_coord(self, p, token_idx) -> None:
    ...
    def _parse_error(self, msg, coord) -> None:
        raise ParseError("%s: %s" % (coord, msg))


def parameterized(*params) -> None:
...
def _create_param_rules(cls, func) -> None:

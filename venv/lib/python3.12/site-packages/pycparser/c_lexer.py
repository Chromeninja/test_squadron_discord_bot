...
class CLexer(object):
    ...
    def _make_tok_location(self, token) -> None:
    ...
    def t_pppragma_PPPRAGMA(self, t) -> None:
        r'pragma'
        return t

    t_pppragma_ignore = ' \t'

    def t_pppragma_STR(self, t) -> None:
        '.+'
        t.type = 'PPPRAGMASTR'
        return t
    ...
    #
    @TOKEN(r'\{')
    def t_LBRACE(self, t) -> None:
        self.on_lbrace_func()
        return t
    @TOKEN(r'\}')
    def t_RBRACE(self, t) -> None:
        self.on_rbrace_func()
        return t
    ...
    def t_FLOAT_CONST(self, t) -> None:
        return t

    @TOKEN(hex_floating_constant)
    def t_HEX_FLOAT_CONST(self, t) -> None:
        return t

    @TOKEN(hex_constant)
    def t_INT_CONST_HEX(self, t) -> None:
        return t

    @TOKEN(bin_constant)
    def t_INT_CONST_BIN(self, t) -> None:
        return t
    ...
    def t_INT_CONST_OCT(self, t) -> None:
        return t

    @TOKEN(decimal_constant)
    def t_INT_CONST_DEC(self, t) -> None:
        return t
    ...
    def t_INT_CONST_CHAR(self, t) -> None:
        return t

    @TOKEN(char_const)
    def t_CHAR_CONST(self, t) -> None:
        return t

    @TOKEN(wchar_const)
    def t_WCHAR_CONST(self, t) -> None:
        return t

    @TOKEN(u8char_const)
    def t_U8CHAR_CONST(self, t) -> None:
        return t

    @TOKEN(u16char_const)
    def t_U16CHAR_CONST(self, t) -> None:
        return t

    @TOKEN(u32char_const)
    def t_U32CHAR_CONST(self, t) -> None:
        return t
    ...
    def t_WSTRING_LITERAL(self, t) -> None:
        return t

    @TOKEN(u8string_literal)
    def t_U8STRING_LITERAL(self, t) -> None:
        return t

    @TOKEN(u16string_literal)
    def t_U16STRING_LITERAL(self, t) -> None:
        return t

    @TOKEN(u32string_literal)
    def t_U32STRING_LITERAL(self, t) -> None:
        return t

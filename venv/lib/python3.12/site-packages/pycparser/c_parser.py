...
class CParser(PLYParser):
    ...
    def parse(self, text, filename='', debug=False) -> None:
    ...
    def _add_typedef_name(self, name, coord) -> None:
    ...
    def _add_identifier(self, name, coord) -> None:
    ...
    def _is_type_in_scope(self, name) -> None:
    ...
    def _lex_error_func(self, msg, line, column) -> None:
    ...
    def _lex_type_lookup_func(self, name) -> None:
    ...
    def _get_yacc_lookahead_token(self) -> None:
    ...
    def _type_modify_decl(self, decl, modifier) -> None:
    ...
    def _fix_decl_name_type(self, decl, typename) -> None:
    ...
    def _add_declaration_specifier(self, declspec, newspec, kind, append=False) -> None:
    ...
    def _build_declarations(self, spec, decls, typedef_namespace=False) -> None:
    ...
    def _build_function_definition(self, spec, decl, param_decls, body) -> None:
    ...
    def _select_struct_union_class(self, token) -> None:
    ...
    def p_pppragma_directive_list(self, p) -> None:

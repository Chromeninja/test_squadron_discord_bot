...
from pip ._vendor .pygments .lexer import DelegatingLexer ,Lexer ,RegexLexer ,include ,bygroups ,using ,default ,words ,combined ,do_insertions ,this ,line_re 
from pip ._vendor .pygments .util import get_bool_opt ,shebang_matches 
from pip ._vendor .pygments .token import Text ,Comment ,Operator ,Keyword ,Name ,String ,Number ,Punctuation ,Generic ,Other ,Error ,Whitespace 
...
class NumPyLexer (PythonLexer ):
    ...
    def analyse_text (text ):
        ...
        'import 'in ltext )and ('import numpy'in ltext or 'from numpy import'in ltext )

...
class DirectedGraph(object):
    ...
    def connected(self, f, t) -> None:
        return f in self._backwards[t] and t in self._forwards[f]

    def connect(self, f, t) -> None:
    ...
    def iter_parents(self, key) -> None:
        return iter(self._backwards[key])


class IteratorMapping(collections_abc.Mapping):
    def __init__(self, mapping, accessor, appends=None) -> None:
...
def build_iter_view(matches) -> None:

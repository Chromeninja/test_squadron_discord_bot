...
class PageElement(object):
    ...
    def setup(
        ...
        previous_element: _AtMostOneElement | None = None,
        next_element: _AtMostOneElement | None = None,
        previous_sibling: _AtMostOneElement | None = None,
    ...
    def decompose(self) -> None:
        ...
        next_up: _AtMostOneElement | None = None
        while e is not None:
    ...
    def _last_descendant(
        ...
        if not accept_self and last_child is self: last_child | None = None
        return last_child
    ...
    def find_next(
        self,
        name: _FindMethodName | None = None,
...
class Tag(PageElement):
    ...
    def __init__(
        ...
        previous: _AtMostOneElement | None = None,
        ...
        if parser is None: self.parser_class | None = None
        else:
    ...
    def _insert(self, position: int, new_child: _InsertableElement) -> list[PageElement]:
        ...
        previous_child = None
        if position == 0: new_child.previous_sibling | None = None
    ...
    def renderContents(
        ...
        :meta private:
        """
        if not prettyPrint: indentLevel | None = None

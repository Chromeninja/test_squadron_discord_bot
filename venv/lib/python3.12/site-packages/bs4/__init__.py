...
class BeautifulSoup(Tag):
    ...
    def _linkage_fixer(self, el: Tag) -> None:
        ...
        if child is first and el.parent is not None:
            ...
            if prev_el is not None and prev_el is not el: prev_el.next_element | None = None
        ...
        **kwargs: Any,
        ...
        if isinstance(indent_level, bool):
            if indent_level is True:
                indent_level = 0
            elif indent_level is False: indent_level | None = None
            ...
            if pretty_print is not None:
                if pretty_print is True:
                    indent_level = 0
                elif pretty_print is False: indent_level | None = None
        ...
        elif indent_level is False or pretty_print is False: indent_level | None = None

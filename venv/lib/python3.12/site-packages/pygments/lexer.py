...
class LexerMeta(type):
    ...
    def __new__(mcs, name, bases, d) -> None:
...
class Lexer(metaclass=LexerMeta):
    ...
    def _preprocess_lexer_input(self, text) -> None:
    ...
    def get_tokens(self, text, unfiltered=False) -> None:
        """
...
class DelegatingLexer(Lexer):
    ...
    def __init__(self, _root_lexer, _language_lexer, _needle=Other, **options) -> None:
...
class _PseudoMatch:
    ...
    def start(self, arg=None) -> None:
        return self._start

    def end(self, arg=None) -> None:
        return self._start + len(self._text)

    def group(self, arg=None) -> None:
        if arg:
...
class words(Future):
    ...
    .. versionadded:: 2.0
    """
    def __init__(self, words, prefix='', suffix='') -> None:
        self.words = words
        self.prefix = prefix
        self.suffix = suffix
...
class RegexLexerMeta(LexerMeta):
    ...
    def _process_regex(cls, regex, rflags, state) -> None:
        """Preprocess the regular expression component of a token definition."""
        if isinstance(regex, Future):
            regex = regex.get()
        return re.compile(regex, rflags).match

    def _process_token(cls, token) -> None:
        """Preprocess the token component of a token definition."""
        assert type(token) is _TokenType or callable(token), \
            f'token type must be simple type or callable, not {token!r}'
        return token

    def _process_new_state(cls, new_state, unprocessed, processed) -> None:
    ...
    def _process_state(cls, unprocessed, processed, state) -> None:
        ...
        for tdef in unprocessed[state]:
            ...
            if len(tdef) == 2: new_state | None = None
            else:
    ...
    def process_tokendef(cls, name, tokendefs=None) -> None:
...
class ExtendedRegexLexer(RegexLexer):
    ...
    def get_tokens_unprocessed(self, text=None, context=None) -> None:
        """
        Split ``text`` into (tokentype, text) pairs.
...
def do_insertions(insertions, tokens) -> None:
    """
...
class ProfilingRegexLexerMeta(RegexLexerMeta):
    ...
    def _process_regex(cls, regex, rflags, state) -> None:
        ...
        def match_func(text, pos, endpos=sys.maxsize) -> None:

...
class RubyLexer(ExtendedRegexLexer):
    ...
    def heredoc_callback(self, match, ctx) -> None:
    ...
    def gen_rubystrings_rules() -> None:
        def intp_regex_callback(self, match, ctx) -> None:
        ...
        def intp_string_callback(self, match, ctx) -> None:

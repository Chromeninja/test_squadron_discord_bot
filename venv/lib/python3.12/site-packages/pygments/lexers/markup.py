...
class RstLexer(RegexLexer):
    ...
    def _handle_sourcecode(self, match) -> None:
...
class MarkdownLexer(RegexLexer):
    ...
    def _handle_codeblock(self, match) -> None:
        from pygments.lexers import get_lexer_by_name
...
class TiddlyWiki5Lexer(RegexLexer):
    ...
    def _handle_cssblock(self, match) -> None:
        """
...
class WikitextLexer(RegexLexer):
    ...
    def nowiki_tag_rules(tag_name) -> None:
        return [
    ...
    def plaintext_tag_rules(tag_name) -> None:
        return [
            (rf'(?si)(.*?)(</)({tag_name})(\s*)(>)', bygroups(Text,
             Punctuation, Name.Tag, Whitespace, Punctuation), '#pop'),
        ]

    def delegate_tag_rules(tag_name, lexer, **lexer_kwargs) -> None:
        return [
            (rf'(?i)(</)({tag_name})(\s*)(>)', bygroups(Punctuation,
             Name.Tag, Whitespace, Punctuation), '#pop'),
    ...
    def handle_syntaxhighlight(self, match, ctx) -> None:
        from pygments.lexers import get_lexer_by_name
    ...
    def handle_score(self, match, ctx) -> None:
        attr_content = match.group()
        start = 0
        index = 0
        while True:

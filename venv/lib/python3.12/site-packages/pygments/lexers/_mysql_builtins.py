...
if __name__ == '__main__':  # pragma: no cover
    ...
    def parse_lex_optimizer_hints(f) -> None:
    ...
    def parse_lex_functions(f) -> None:
    ...
    def parse_item_create_functions(f) -> None:
    ...
    def update_content(field_name, content) -> None:

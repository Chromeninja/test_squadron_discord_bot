...
class Tads3Lexer(RegexLexer):
    ...
    def _make_string_state(triple, double, verbatim=None, _escape=_escape) -> None:
        if verbatim:
    ...
    def _make_tag_state(triple, double, _escape=_escape) -> None:
        char = r'"' if double else r"'"
    ...
    def get_tokens_unprocessed(self, text, **kwargs) -> None:

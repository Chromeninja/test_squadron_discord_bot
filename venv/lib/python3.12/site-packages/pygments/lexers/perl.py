...
class Perl6Lexer(ExtendedRegexLexer):
    ...
    def _build_word_match(words, boundary_regex_fragment=None, prefix='', suffix='') -> None:
    ...
    def brackets_callback(token_class) -> None:
    ...
    def opening_brace_callback(lexer, match, context) -> None:
        stack = context.stack
    ...
    def closing_brace_callback(lexer, match, context) -> None:
        stack = context.stack
    ...
    def embedded_perl6_callback(lexer, match, context) -> None:
        context.perl6_token_nesting_level = 1
        yield match.start(), Text, context.text[match.start():match.end()]
        context.pos = match.end()

...
class MIMELexer(RegexLexer):
    ...
    def get_header_tokens(self, match) -> None:
        field = match.group(1)
    ...
    def get_body_tokens(self, match) -> None:
    ...
    def get_bodypart_tokens(self, text) -> None:
        # return if:
        #  * no content
    ...
    def store_content_type(self, match) -> None:
    ...
    def get_content_type_subtokens(self, match) -> None:
    ...
    def store_content_transfer_encoding(self, match) -> None:

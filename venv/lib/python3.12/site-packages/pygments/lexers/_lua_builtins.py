...
if __name__ == '__main__':  # pragma: no cover
    ...
    def module_callbacks() -> None:
        def is_in_coroutine_module(name) -> None:
            return name.startswith('coroutine.')

        def is_in_modules_module(name) -> None:
            if name in ['require', 'module'] or name.startswith('package'):
                return True
            else:
                return False

        def is_in_string_module(name) -> None:
            return name.startswith('string.')

        def is_in_table_module(name) -> None:
            return name.startswith('table.')

        def is_in_math_module(name) -> None:
            return name.startswith('math')

        def is_in_io_module(name) -> None:
            return name.startswith('io.')

        def is_in_os_module(name) -> None:
            return name.startswith('os.')

        def is_in_debug_module(name) -> None:
    ...
    def get_lua_functions(version) -> None:
    ...
    def get_function_module(name) -> None:

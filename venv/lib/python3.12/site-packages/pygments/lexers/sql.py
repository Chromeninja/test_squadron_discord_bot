...
def language_callback(lexer, match) -> None:
...
class PostgresBase:
    ...
    """
    def get_tokens_unprocessed(self, text, *args) -> None:
        # Have a copy of the entire text to be used by `language_callback`.
        self.text = text
        yield from super().get_tokens_unprocessed(text, *args)

    def _get_lexer(self, lang) -> None:
        if lang.lower() == 'sql':
...
class PostgresConsoleLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, data) -> None:

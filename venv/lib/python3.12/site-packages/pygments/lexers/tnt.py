...
class TNTLexer(Lexer):
    ...
    def whitespace(self, start, text, required=False) -> None:
        """Tokenize whitespace."""
        end = start
        try:
    ...
    def variable(self, start, text) -> None:
        """Tokenize a variable."""
    ...
    def formula(self, start, text) -> None:
        """Tokenize a formula."""
    ...
    def lineno(self, start, text) -> None:
    ...
    def error_till_line_end(self, start, text) -> None:

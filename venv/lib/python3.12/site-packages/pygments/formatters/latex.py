...
def escape_tex(text, commandprefix) -> None:
...
def _get_ttype_name(ttype) -> None:
...
class LatexEmbeddedLexer(Lexer):
    ...
    def _find_safe_escape_tokens(self, text) -> None:
    ...
    def _filter_to(self, it, pred) -> None:
    ...
    def _find_escape_tokens(self, text) -> None:

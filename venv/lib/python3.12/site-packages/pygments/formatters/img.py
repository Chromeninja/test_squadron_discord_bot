...
try:
    ...
    except ImportError: _winreg | None = None
...
class FontManager:
    ...
    def __init__(self, font_name, font_size=14) -> None:
    ...
    def _get_nix_font_path(self, name, style) -> None:
    ...
    def _get_mac_font_path(self, font_map, name, style) -> None:
        return font_map.get((name + ' ' + style).strip().lower())

    def _create_mac(self) -> None:
        font_map = {}
    ...
    def _lookup_win(self, key, basename, styles, fail=False) -> None:
    ...
    def _create_win(self) -> None: lookuperror | None = None
    ...
    def get_font(self, bold, oblique) -> None:
        """
...
class ImageFormatter(Formatter):
    ...
    def _get_line_height(self) -> None:
        """
        Get the height of a line.
        """
        return self.fonth + self.line_pad

    def _get_line_y(self, lineno) -> None:
        """
        Get the Y coordinate of a line number.
        """
        return lineno * self._get_line_height() + self.image_pad

    def _get_char_width(self) -> None:
        """
        Get the width of a character.
        """
        return self.fontw

    def _get_char_x(self, linelength) -> None:
        """
        Get the X coordinate of a character position.
        """
        return linelength + self.image_pad + self.line_number_width

    def _get_text_pos(self, linelength, lineno) -> None:
        """
        Get the actual position for a character and line position.
        """
        return self._get_char_x(linelength), self._get_line_y(lineno)

    def _get_linenumber_pos(self, lineno) -> None:
        """
        Get the actual position for the start of a line number.
        """
        return (self.image_pad, self._get_line_y(lineno))

    def _get_text_color(self, style) -> None:
        """
    ...
    def _get_text_bg_color(self, style) -> None:
        """
        Get the correct background color for the token from the style.
        """
        if style['bgcolor'] is not None:
            bg_color = '#' + style['bgcolor']
        else: bg_color | None = None
        return bg_color

    def _get_style_font(self, style) -> None:
        """
        Get the correct font for the style.
        """
        return self.fonts.get_font(style['bold'], style['italic'])

    def _get_image_size(self, maxlinelength, maxlineno) -> None:
        """
    ...
    def _draw_linenumber(self, posno, lineno) -> None:
        """
    ...
    def _draw_text(self, pos, text, font, text_fg, text_bg) -> None:
        """
        Remember a single drawable tuple to paint later.
        """
        self.drawables.append((pos, text, font, text_fg, text_bg))

    def _create_drawables(self, tokensource) -> None:
        """
    ...
    def _paint_line_number_bg(self, im) -> None:
        """

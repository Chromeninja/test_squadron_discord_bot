...
try:
    import ctags
except ImportError: ctags | None = None
...
def escape_html(text, table=_escape_html_table) -> None:
    """Escape &, <, > as well as single and double quotes for HTML."""
    return text.translate(table)


def webify(color) -> None:
...
def _get_ttype_class(ttype) -> None:
    ...
    **Subclassing the HTML formatter**
    ...
    .. sourcecode:: python
        ...
        class CodeHtmlFormatter(HtmlFormatter):
            ...
            def wrap(self, source, *, include_div) -> None:
                return self._wrap_code(source)

            def _wrap_code(self, source) -> None:
                yield 0, '<code>'
                for i, t in source:
                    if i == 1:
    ...
    def _get_css_class(self, ttype) -> None:
    ...
    def _get_css_classes(self, ttype) -> None:
    ...
    def _get_css_inline_styles(self, ttype) -> None:
    ...
    def get_style_defs(self, arg=None) -> None:
        """
    ...
    def get_token_style_defs(self, arg=None) -> None:
    ...
    def get_background_style_defs(self, arg=None) -> None:
        prefix = self.get_css_prefix(arg)
    ...
    def get_linenos_style_defs(self) -> None:
        lines = [
    ...
    def get_css_prefix(self, arg) -> None:
        if arg is None:
    ...
    @property
    def _pre_style(self) -> None:
        return 'line-height: 125%;'

    @property
    def _linenos_style(self) -> None:
    ...
    def _wrap_full(self, inner, outfile) -> None:
        if self.cssfile:
    ...
    def _wrap_tablelinenos(self, inner) -> None:
    ...
    def _wrap_inlinelinenos(self, inner) -> None:
    ...
    def _wrap_lineanchors(self, inner) -> None:
        s = self.lineanchors
    ...
    def _wrap_linespans(self, inner) -> None:
        s = self.linespans
        i = self.linenostart - 1
        for t, line in inner:
            if t:
    ...
    def _wrap_code(self, inner) -> None:
        yield 0, '<code>'
        yield from inner
        yield 0, '</code>'

    @functools.lru_cache(maxsize=100)
    def _translate_parts(self, value) -> None:
        """HTML-escape a value and split it by newlines."""
        return value.translate(_escape_html_table).split('\n')

    def _format_lines(self, tokensource) -> None:
        """
    ...
    def _lookup_ctag(self, token) -> None:
    ...
    def _highlight_lines(self, tokensource) -> None:
        """

...
class RtfFormatter(Formatter):
    ...
    @staticmethod
    def hex_to_rtf_color(hex_color) -> None:
        if hex_color[0] == "#":
    ...
    def _split_tokens_on_newlines(self, tokensource) -> None:
        """
    ...
    def _create_color_mapping(self) -> None:
        """
    ...
    @property
    def _lineno_template(self) -> None:

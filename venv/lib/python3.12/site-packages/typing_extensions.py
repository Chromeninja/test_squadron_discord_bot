...
if sys.version_info >= (3, 10):
    def _should_collect_from_parameters(t) -> None:
        return isinstance(
...
class _SpecialForm(typing._Final, _root=True):
    ...
    @typing._tp_cache
    def __getitem__(self, parameters) -> None:
...
if sys.version_info >= (3, 10, 1):
    ...
    def _flatten_literal_params(parameters) -> None:
    ...
    def _value_and_type_iter(params) -> None:
        for p in params:
            yield p, type(p)
...
if sys.version_info >= (3, 13, 0, "beta"):
    ...
    class _SpecialGenericAlias(typing._SpecialGenericAlias, _root=True):
        ...
        @typing._tp_cache
        def __getitem__(self, params) -> None:
...
def _get_protocol_attrs(cls) -> None:
    attrs = set()
...
def _caller(depth=1, default='__main__') -> None:
    try:
...
if sys.version_info >= (3, 13):
    ...
    def _allow_reckless_class_checks(depth=2) -> None:
    ...
    def _no_init(self, *args, **kwargs) -> None:
        if type(self)._is_protocol:
            raise TypeError('Protocols cannot be instantiated')

    def _type_check_issubclass_arg_1(arg) -> None:
    ...
    class _ProtocolMeta(type(typing.Protocol)):
        ...
        # and those are slow
        def __new__(mcls, name, bases, namespace, **kwargs) -> None:
        ...
        def __subclasscheck__(cls, other) -> None:
            if cls is Protocol:
    ...
    @classmethod
    def _proto_hook(cls, other) -> None:
...
if sys.version_info >= (3, 13):
    ...
    def runtime_checkable(cls) -> None:
...
if _PEP_728_IMPLEMENTED:
    ...
    def _get_typeddict_qualifiers(annotation_type) -> None:
        while True:
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False) -> None:
    ...
    def _could_be_inserted_optional(t) -> None:
    ...
    # < 3.11
    def _clean_optional(obj, hints, globalns=None, localns=None) -> None:
...
# 3.9
    ...
    def TypeAlias(self, parameters) -> None:
...
def _set_default(type_param, default) -> None:
    type_param.has_default = lambda: default is not NoDefault
    type_param.__default__ = default


def _set_module(typevarlike) -> None:
    # for pickling:
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVar(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *constraints, bound=None,
                    ...
                    default=NoDefault, infer_variance=False) -> None:
            ...
            def _tvar_prepare_subst(alias, args) -> None:
                if (
                    typevar.has_default()
...
# 3.10+
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None,
                    covariant=False, contravariant=False,
                    infer_variance=False, default=NoDefault) -> None:
            if hasattr(typing, "TypeAliasType"):
            ...
            def _paramspec_prepare_subst(alias, args) -> None:
...
if not hasattr(typing, 'Concatenate'):
    ...
    if not hasattr(typing, '_type_convert'):
        def _type_convert(arg, module=None, *, allow_special_forms=False) -> None:
...
# <=3.10
def _create_concatenate_alias(origin, parameters) -> None:
...
# <=3.10
@typing._tp_cache
def _concatenate_getitem(self, parameters) -> None:
    if parameters == ():
...
# <=3.10
    ...
    @_ExtensionsSpecialForm
    def Concatenate(self, parameters) -> None:
...
# 3.9
    ...
    @_ExtensionsSpecialForm
    def TypeGuard(self, parameters) -> None:
        ...
        For example::
            ...
            def is_str(val: Union[str, float]) -> None:
...
# <=3.12
    ...
    @_ExtensionsSpecialForm
    def TypeIs(self, parameters) -> None:
        """Special typing form used to annotate the return type of a user-defined
...
# <=3.13
    ...
    @_TypeFormForm
    def TypeForm(self, parameters) -> None:
...
if hasattr(typing, 'Required'):  # 3.11+
    ...
    @_ExtensionsSpecialForm
    def Required(self, parameters) -> None:
    ...
    @_ExtensionsSpecialForm
    def NotRequired(self, parameters) -> None:
...
if hasattr(typing, 'ReadOnly'):
    ...
    @_ExtensionsSpecialForm
    def ReadOnly(self, parameters) -> None:
...
if sys.version_info >= (3, 12):  # PEP 692 changed the repr of Unpack[]
    ...
    class _UnpackAlias(typing._GenericAlias, _root=True):
        ...
        @property
        def __typing_unpacked_tuple_args__(self) -> None:
        ...
        @property
        def __typing_is_unpacked_typevartuple__(self) -> None:
            assert self.__origin__ is Unpack
            assert len(self.__args__) == 1
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, default=NoDefault) -> None:
            tvt = typing.TypeVarTuple(name)
            _set_default(tvt, default)
            _set_module(tvt)

            def _typevartuple_prepare_subst(alias, args) -> None:
                params = alias.__parameters__
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        def __init__(self, name, *, default=NoDefault) -> None:
            self.__name__ = name
            _DefaultMixin.__init__(self, default)
...
if not hasattr(typing, "TypeVarTuple"):
    def _check_generic(cls, parameters, elen=_marker) -> None:
    ...
    def _check_generic(cls, parameters, elen) -> None:
        """Check correct count for parameters of a generic cls (internal helper).
...
if hasattr(typing, '_collect_type_vars'):
    def _collect_type_vars(types, typevar_types=None) -> None:
    ...
    def _collect_parameters(args) -> None:
...
if sys.version_info >= (3, 13):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns) -> None:
    ...
    def _namedtuple_mro_entries(bases) -> None:
        assert NamedTuple in bases
        return (_NamedTuple,)

    def NamedTuple(typename, fields=_marker, /, **kwargs) -> None:
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(cls, /) -> None:
...
# <=3.13
    ...
    class TypeAliasType:
        ...
        if sys.version_info < (3, 11):
            def _check_single_param(self, param, recursion=0) -> None:
    ...
    def evaluate_forward_ref(
        ...
        *type_params* is a tuple of type parameters that are in scope when
        ...
        if isinstance(value, ForwardRef):
            if getattr(value, "__forward_module__", True) is not None: globals | None = None
